...
- [ ] T004 [P] Create deterministic output, cache, and log directories inside
...
- [ ] T005 Build repository discovery manifest to avoid repeated repo walks
- [ ] T006 [P] Implement path-boundary and exclusion enforcement for secret,
      generated, vendored, binary, and oversized inputs
- [ ] T007 [P] Implement deterministic language-routing definitions and support
      status classification
- [ ] T008 Create shared typed schemas and stable ID utilities
- [ ] T009 Configure structured error handling and skip/result logging
- [ ] T010 Setup environment configuration and cost-budget controls
...
- [ ] T011 [P] [US1] Contract or schema test for [artifact/interface] in
      tests/contract/test_[name].py
- [ ] T012 [P] [US1] Integration test for [user journey/stage] in
      tests/integration/test_[name].py
- [ ] T013 [P] [US1] Regression test for exclusions, routing, or partial-result
      behavior in tests/unit/test_[name].py
...
- [ ] T018 [US1] Add evidence metadata, deterministic serialization, and stable
      IDs
- [ ] T019 [US1] Add structured error handling and bounded logging for user
      story 1 operations
...
- [ ] T020 [P] [US2] Contract or schema test for [artifact/interface] in
      tests/contract/test_[name].py
- [ ] T021 [P] [US2] Integration test for [user journey/stage] in
      tests/integration/test_[name].py
...
- [ ] T026 [P] [US3] Contract or schema test for [artifact/interface] in
      tests/contract/test_[name].py
- [ ] T027 [P] [US3] Integration test for [user journey/stage] in
      tests/integration/test_[name].py
...
- [ ] TXXX Validate deterministic outputs, partial-result behavior, and output
      directory placement
...
Task: "Contract or schema test for [artifact/interface] in tests/contract/test_[name].py"
Task: "Integration test for [user journey/stage] in tests/integration/test_[name].py"
Task: "Regression test for exclusions, routing, or partial-result behavior in tests/unit/test_[name].py"
...
- Ensure artifacts, caches, and logs remain inside project-controlled
  directories
